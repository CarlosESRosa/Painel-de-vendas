          ...
          <div className="flex items-center space-x-4">
            {selectedItems.length > 0 && (
              <div className="px-3 py-1 bg-primary-100 text-primary-800 text-sm font-medium rounded-full">
                {selectedItems.length} produto{selectedItems.length !== 1 ? 's' : ''} selecionado
              ...
              <>
                <div className="space-y-3 max-h-[400px] overflow-y-auto">
                  {selectedItems.map((item) => (
                    <div
                      key={item.productId}
                      className="bg-white p-3 rounded-lg border border-secondary-200"
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex-1">
                ...
                <div className="mt-6 pt-4 border-t border-secondary-200">
                  ...
                  <button onClick={handleConfirm} className="w-full btn-primary py-3">
                    {selectedItems.length === 0
                      ? 'Selecionar Produtos'
                      : `Confirmar ${selectedItems.length} Item${
                          selectedItems.length !== 1 ? 's' : ''
                        }`}
                  </button>
                </div>
