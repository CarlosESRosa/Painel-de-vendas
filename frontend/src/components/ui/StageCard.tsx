...
import { CheckIcon, UserIcon, ShoppingBagIcon, CreditCardIcon, DocumentTextIcon, LockClosedIcon } from '@heroicons/react/24/outline'
...
const StageCard = ({ stage, title, description, isCompleted, isActive, onClick, className = '' }: StageCardProps) => {
    const getStageIcon = () => {
    ...
    const getCardClasses = () => {
        ...
        if (isCompleted) {
            baseClasses += " bg-gradient-to-r from-success-600 to-success-700 border-success-500 shadow-lg"
        } else if (isActive) {
            baseClasses += " bg-gradient-to-r from-primary-600 to-primary-700 border-primary-500 shadow-lg cursor-pointer hover:shadow-xl hover:scale-105"
        } else {
